<header class="header navbar fixed-top navbar-expand-md" style="<?php if($page!='index')echo 'background-color:black;' ?> margin:0; padding: 10px">
    <div class="container">
        <a class="navbar-brand logo" href="#">
            <img src="assets/img/logo-new.png" alt="icwite" />
        </a>
